...
const ComponentCard: React.FC<ComponentCardProps> = ({
  ...
  return (
    <div
      className={`${getGlassyClasses()} p-6 flex flex-col h-full cursor-pointer group transition-all duration-300 text-blue-400  hover:scale-105 hover:shadow-xl`}
      onClick={onClick}
    >
      <div className='flex items-center mb-4'>
        <div className='p-2 text-blue-400 rounded-lg mr-4'>{icon}</div>
...
const GlassyUIComponentsPage: React.FC = () => {
  ...
  const getGlassyClasses = () => {
    return 'backdrop-filter backdrop-blur-md bg-white border border-white/20 rounded-2xl shadow-lg transition-all duration-300';
  };
  ...
  return (
    <div className='min-h-screen font-sans bg-gradient-to-br from-blue-300 via-blue-300 to-blue-500'>
      <BackToTopButton />
      <div className='container mx-auto px-4 py-8 lg:py-12'>
        ...
        <main>
          ...
          >
            ...
            Crystal Components components. Perfect for creating modern, sleek
              ...
              >
                <div className='py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6'>
                  <div className='mx-auto max-w-screen-sm text-center'>
                    ...
                    <button
                      className='mt-6 px-4 py-2 bg-blue-600 hover:bg-yellow-500 text-white rounded-lg shadow-md transition-all duration-300'
                      onClick={() => navigate('/')}
                    >
                      Back to Homepage
                    </button>
