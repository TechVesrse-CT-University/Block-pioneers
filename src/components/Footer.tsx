      ...
      <footer className='glass-footer'>
        <div className='footer-content'>
          <p className='footer-description'>
            Elevate your UI with beautifully crafted,Crystals Component components.
        ...
        >
          ...
          <div className='footer-top flex flex-col items-center justify-center gap-2'>
            ...
            <p className='text-sm text-center'>
              Get the latest updates, news, and resources about Crystals Component.
            </p>
          </div>
